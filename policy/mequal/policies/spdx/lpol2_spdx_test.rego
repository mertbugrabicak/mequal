package mequal.policies.spdx.LPOL2_SPDX_test

import data.ec.lib
import data.ec.lib.util.assert_passes_rules
import data.ec.lib.util.assert_violates_rules
import data.mequal.policies.spdx.LPOL2_SPDX
import rego.v1

_rule_spdx_sbom_all_components_contain_versions := "mequal.policies.spdx.LPOL2_SPDX.spdx_sbom_all_components_contain_versions"

_rule_spdx_sbom_has_packages_field := "mequal.policies.spdx.LPOL2_SPDX.spdx_sbom_has_packages_field"

_rule_spdx_sbom_packages_field_not_empty := "mequal.policies.spdx.LPOL2_SPDX.spdx_sbom_packages_field_not_empty"
...
test_prerequisite if {
	...
	results := LPOL2_SPDX.deny with input as sbom
